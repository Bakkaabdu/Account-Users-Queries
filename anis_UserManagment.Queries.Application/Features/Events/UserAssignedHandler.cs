...
{
    public class UserAssignedHandler : IRequestHandler<Event<UserAssignedData>, bool>
    {
        private readonly IUnitOfWork _unitOfWork;

        public UserAssignedHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }
        public async Task<bool> Handle(Event<UserAssignedData> request, CancellationToken cancellationToken)
        {
